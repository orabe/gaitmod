...
def build_pipeline(model_type='seq2seq_lstm', mask_values=None,
    ...
    Args:
        model_type: Type of classifier ('dummy', 'rf', 'svm', 'xgb', 'logreg', 'seq2seq_lstm', 'seq2vec_lstm')
    ...
    selector_mask_value = None if model_type == 'seq2vec_lstm' else mask_values.get('X_mask', 0.0)
    ...
    if model_type == 'seq2seq_lstm':
        ...
        logging.info(f"[BUILD_PIPELINE] Adding MaskAwareScaler for seq2vec LSTM (no masking applied)")
